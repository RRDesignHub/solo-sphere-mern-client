...
export const BidsRequestRow = ({bid, handleStatusChange}) => {
  const {_id, jobTitle, bidderEmail, biddingDate, bidPrice, jobCategory, status} = bid || {};
  return (
    <tr>
